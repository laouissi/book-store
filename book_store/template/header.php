...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header"  >
          ...
          <div class="row">
            <a class="navbar-brand" href="index.php" col-md-3>AGORA</a>
    ...
    <div class="jumbotron" style="  background: url('https://wallpaperaccess.com/full/124383.jpg') no-repeat center center;background-size: cover;height:400px
;
  " >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto;color:white">WELCOME TO AGORA</h1>   
